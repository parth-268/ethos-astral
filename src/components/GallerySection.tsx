// src/components/GallerySection.tsx - Optimized Version
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10" ref={ref}>
        ...
        >
          ...
          >
            <ImageIcon className="w-3 h-3 md:w-4 md:h-4" aria-hidden="true" />
            Visual Archives
          </motion.div>
          <h2
            id="gallery-heading"
            className="font-display text-4xl sm:text-5xl md:text-7xl text-gradient-aurora mb-4 md:mb-6 leading-tight"
          >
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6 bg-gradient-to-t from-black/90 to-transparent pointer-events-none z-20">
            <div className="flex items-center gap-3 md:gap-4">
              <div
                className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-purple-600 flex items-center justify-center text-white shadow-lg shadow-purple-600/50"
                aria-hidden="true"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {GALLERY_ARCHIVES.map((archive, index) => {
            ...
            return (
              ...
              >
                <Link
                  ...
                  aria-label={`View ${archive.year} gallery - ${archive.title}`}
                >
                  <div className="relative h-full w-full rounded-2xl overflow-hidden border border-white/10 transition-all duration-500 md:group-hover:-translate-y-2 md:group-hover:shadow-[0_0_30px_rgba(168,85,247,0.3)]">
                    <div className="absolute inset-0">
                      <img
                        src={optimizedImage}
                        alt={`${archive.title} - ${archive.year}`}
                    ...
                    <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-end">
                      <div className="transform transition-transform duration-500 md:translate-y-4 md:group-hover:translate-y-0">
                        <span
                          className="text-5xl md:text-6xl font-display text-white/10 absolute -top-8 -left-2 select-none"
                          aria-hidden="true"
                        >
                          {archive.year}
                        </span>
